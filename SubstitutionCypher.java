...
public class SubstitutionCypher {
	...
	public void decode() {
		for(String secretCode : nlist) {
	    	List<String> possibleCombinations = getStringCombinations(secretCode);
	...
	/**
	 * list of all combinations to check
	 * @param secret the code to decipher
	 * @return all combinations of possible matches for each sub string in the code
	 */
	private List<String> getStringCombinations(String secret) {
		if(null == secret)
			return null;
