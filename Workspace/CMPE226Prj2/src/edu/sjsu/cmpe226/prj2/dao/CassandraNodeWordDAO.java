...
public class CassandraNodeWordDAO implements WordGraphDAO {
	...
	public CassandraNodeWordDAO() {
		// connect to the database		
				CassandraHostConfigurator cassandraHostConfigurator = new CassandraHostConfigurator(
					       "127.0.0.1:9160,127.0.0.2:9160, 127.0.0.3:9160");
				...
				// In this we use quorum for read and writes. But you can use different CLs if needed.
				configurableConsistencyLevel.setReadCfConsistencyLevels(clmap);
				configurableConsistencyLevel.setWriteCfConsistencyLevels(clmap);

				// Then let the keyspace know					
				 keyspaceOperator = HFactory.createKeyspace("wiktionary", cluster, configurableConsistencyLevel);
	...
	private void createNewColumn(String w){
		...
		System.out.println("Parts of speech="+w.getPartsOfSpeech());
		
		PartsOfSpeech abc = PartsOfSpeech.valueOf("Preposition");
	
		
		System.out.println("Parts of speech ABC="+abc.toString());
