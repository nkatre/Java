...
import edu.sjsu.cmpe295b.planhercareer.blog.dao.Neo4JDocumentGraphDAO;
import edu.sjsu.cmpe295b.planhercareer.blog.dao.DocumentGraphDAO;
import edu.sjsu.cmpe295b.planhercareer.blog.dto.DocumentData;
import edu.sjsu.cmpe295b.planhercareer.blog.util.RateMonitor;

public class BulkLoadTestNeo 
{
	public static final String NEO4J_DB = "C://neo4jdbdata//careerplan.db";
	...
	private DocumentData createDocumentData(String line)
	{
		...
		try
		{
			...
			DocumentData.setConcept(getSetFromString(cols[3]));
		} catch (Exception ex) {
