...
GLASSDOOR_ROOT = 'http://www.glassdoor.com';
...
def parse_exactMatch(soup):
   ...
   selector = {'class': 'item org emphasizedLink'}
   for company in companies:
      if ( '(exact match)' in company.text):
         link = company.findAll('a', selector)[0]['href'];
         return link
   #No Match
   return companies[0].findAll('a', selector)[0]['href'];
